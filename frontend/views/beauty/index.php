...
<header id="container2" style="background: #226039 url(/image/2.jpg) center 0 scroll no-repeat;">
    ...
    <div id="nav" class="menu-%e7%94%b5%e8%84%91%e8%8f%9c%e5%8d%95-container">
        <ul id="menu-%e7%94%b5%e8%84%91%e8%8f%9c%e5%8d%95" class="menu">
            ...
            <li id="menu-item-162" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-162 current-menu-item current_page_item "><a href="<?=Url::toRoute('/beauty/index')?>">优美散文</a></li>
...
<div class="mainContent">
    ...
    <div class="blogitem">
        ...
        <article>
            <h2 class="title"><a href="<?=Url::toRoute(['/beauty/detail','id' => $value->id]);?>" title="<?=$value->title;?>"><?=$value->title;?></a></h2>
            <ul class="text">
